  ...
  return (
    <div className='flex flex-col lg:flex-row flex-shrink-0 justify-center gap-12 mb-16'>
      <div className='max-w-md text-center'>
        <h4 className='text-3xl font-semibold mb-4'>Ready to grow your brand?</h4>
        <p className='text-lg mb-6'>Let’s work together and build something amazing for your business.</p>
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between items-end gap-8'>
      ...
      <div className='flex flex-col items-end gap-2 text-sm'>
        ...
        <p className='text-xs text-[#ffffff80]'>© {new Date().getFullYear()} Spark Studio. All rights reserved.</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className='flex flex-wrap gap-12 justify-center'>
      {navs.map((section, index) => (
        <div key={index} className='flex flex-col gap-4 min-w-[180px] text-center'>
          <h3 className='mb-2 text-lg font-semibold uppercase text-primary'>{section.title}</h3>
